...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 2
    answer = count_cosines_from(0, 5, 0.5)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 5
    answer = count_cosines_from(5, 10, 0.25)
    ...
    # Test 5:
    expected = 2
    answer = count_cosines_from(4, 6, 0.15)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 0
    answer = count_cosines_from(3, 4, 1)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 2.283333  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 5)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 0.274242  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(10, 12)
